...
})({"eYk8U":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7160216b0d972a35";
...
},{}],"ixaFm":[function(require,module,exports) {
...
function myCompletions(context) {
    if (currentRowText.length > 0 && currentRowText[0] == " " || currentRowText.length < 3 || currentRowText.split(" ").length > 2) searchOptions = [];
...
const cursorTooltipField = _state.StateField.define({
    create: getCursorTooltips,
    update (tooltips, tr) {
        if (!tr.docChanged && !tr.selection) return tooltips;
        return getCursorTooltips(tr.state);
    },
    provide: (f)=>_tooltip.showTooltip.computeN([
            f
        ], (state)=>state.field(f)
        )
});
...
function fetchAutoComplete(startsWith) {
    ...
    axios.post("https://api.mi1.ai/api/autocompleteProblems", body, {
        headers
    }).then(function(response) {
        if (response.data.length > 0) searchOptions = [];
            ...
            searchOptions.push({
                ...
                apply: ()=>{
                    ...
                    view.dispatch(view.state.update({
                        selection: new _state.EditorSelection([
                            _state.EditorSelection.cursor(currentPosition)
                        ], 0)
                    }));
                }
            });
...
function fetchProblems(CUI) {
    ...
    axios.post("https://api.mi1.ai/api/PotentialComorbidities", cuisBody, {
        headers
    }).then(function(response) {
        suggestions.innerHTML = "";
        if (response.data.length > 0) suggestions.innerHTML += "<div><h3>Associated Conditions:</h3></div>";
        var suggestion_str = "";
        for(var i = 0; i <= response.data.length - 1; i++){
...
function fetchOrders(CUI) {
    ...
    document.getElementById("preloader").style.display = "inline-flex";
    axios.post("https://api.mi1.ai/api/AssocOrders", bodyUI, {
        headers
    }).then(function(response) {
        suggestions.innerHTML = "";
        if (response.data.length > 0) suggestions.innerHTML += "<div><h3>Orders Associated with Problem:</h3></div>";
        var suggestion_str = "";
        for(var i = 0; i <= response.data.length - 1; i++){
            suggestion_str += "<div class='suggestion' data-type='order' data-problem-cui='" + CUI + "' data-cui='" + response.data[i].Code + "' data-name='" + response.data[i].Order + "'>";
            suggestion_str += "<h5 class='suggestion-text'>";
...
function getCursorTooltips(state) {
    return state.selection.ranges.filter((range)=>range.empty
        ...
        if (currentRowText.length == 3 && currentRowText[0] != "" && currentRowText[0] != "\t") fetchAutoComplete(currentRowText);
...
const initialState = _basicSetup.EditorState.create({
    doc: "",
    extensions: [
        ...
        _basicSetup.EditorView.lineWrapping,
        _language.indentUnit.of("\t"), 
    ]
});
// Initialization of the EditorView
const view = new _basicSetup.EditorView({
...
function highlightSuggestions() {
    ...
    for(var i = 0; i <= all_suggestions.length - 1; i++){
        ...
        if (index !== -1) {
            if (arrCUIs[index]["type"] == elem.getAttribute("data-type")) view && view.viewState.state.doc.text.forEach((e)=>{
                e.toString().toLowerCase().replace(/\s/g, "").replace("\t", "") == elem.getAttribute("data-name").toLowerCase().replace(/\s/g, "") && elem.classList.add("highlighted");
            });
        }
    }
}

},{"@codemirror/basic-setup":"6nyFJ","@codemirror/view":"fBkgq","@codemirror/commands":"eGPMG","@codemirror/autocomplete":"daAey","@codemirror/state":"80zPS","@codemirror/tooltip":"iwWKb","@codemirror/language":"gATQT","axios":"jo6P5"}],"6nyFJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "EditorView", ()=>_view.EditorView
);
parcelHelpers.export(exports, "EditorState", ()=>_state.EditorState
);
...
desired.
*/ const basicSetup = [
    /*@__PURE__*/ _gutter.lineNumbers(),
    /*@__PURE__*/ _gutter.highlightActiveLineGutter(),
    /*@__PURE__*/ _view.highlightSpecialChars(),
    /*@__PURE__*/ _history.history(),
    /*@__PURE__*/ _fold.foldGutter(),
    /*@__PURE__*/ _view.drawSelection(),
    /*@__PURE__*/ _view.dropCursor(),
    /*@__PURE__*/ _state.EditorState.allowMultipleSelections.of(true),
    /*@__PURE__*/ _language.indentOnInput(),
    _highlight.defaultHighlightStyle.fallback,
    /*@__PURE__*/ _matchbrackets.bracketMatching(),
    /*@__PURE__*/ _closebrackets.closeBrackets(),
    /*@__PURE__*/ _autocomplete.autocompletion(),
    /*@__PURE__*/ _rectangularSelection.rectangularSelection(),
    /*@__PURE__*/ _view.highlightActiveLine(),
    /*@__PURE__*/ _search.highlightSelectionMatches(),
    /*@__PURE__*/ _view.keymap.of([
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@codemirror/history":"cM1BM","@codemirror/fold":"bAOW1","@codemirror/language":"gATQT","@codemirror/gutter":"9zb6V","@codemirror/commands":"eGPMG","@codemirror/matchbrackets":"1wlba","@codemirror/closebrackets":"ermsz","@codemirror/search":"4laib","@codemirror/autocomplete":"daAey","@codemirror/comment":"iuCDm","@codemirror/rectangular-selection":"h0fKo","@codemirror/highlight":"27yTu","@codemirror/lint":"5PM0d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fBkgq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function posInCompositionTree(pos, view, text) {
    ...
    } else if (view.dom == text) return new DOMPos(text, Math.min(pos, text.nodeValue.length));
    else return view.domAtPos(pos);
}
...
},{"@codemirror/state":"80zPS","style-mod":"hU20f","@codemirror/rangeset":"2SfPZ","@codemirror/text":"1TE0D","w3c-keyname":"aiTuv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"80zPS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class FacetProvider {
    ...
    dynamicSlot(addresses) {
        ...
        return {
            ...
            update (state, tr) {
                if (depDoc && tr.docChanged || depSel && (tr.docChanged || tr.selection) || depAddrs.some((addr)=>(ensureAddr(state, addr) & 1 /* Changed */ ) > 0
                )) {
    ...
    static resolve(base, compartments, oldState) {
        ...
        for(let id in facets){
            ...
            if (providers.every((p)=>p.type == 0 /* Static */ 
                ...
                for (let p of providers)if (p.type == 0 /* Static */ ) {
...
*/ class EditorState {
    ...
    */ applyTransaction(tr) {
        ...
        new EditorState(conf, tr.newDoc, tr.newSelection, startValues, (state, slot)=>slot.update(state, tr)
        , tr);
    }
    /**
...
},{"@codemirror/text":"1TE0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1TE0D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2SfPZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"80zPS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aiTuv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cM1BM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"80zPS","@codemirror/view":"fBkgq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bAOW1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"80zPS","@codemirror/view":"fBkgq","@codemirror/language":"gATQT","@codemirror/gutter":"9zb6V","@codemirror/rangeset":"2SfPZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gATQT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@lezer/common":"6NJEQ","@codemirror/state":"80zPS","@codemirror/view":"fBkgq","@codemirror/text":"1TE0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6NJEQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9zb6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/view":"fBkgq","@codemirror/rangeset":"2SfPZ","@codemirror/state":"80zPS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eGPMG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"80zPS","@codemirror/text":"1TE0D","@codemirror/view":"fBkgq","@codemirror/matchbrackets":"1wlba","@codemirror/language":"gATQT","@lezer/common":"6NJEQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1wlba":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"80zPS","@codemirror/language":"gATQT","@codemirror/view":"fBkgq","@lezer/common":"6NJEQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ermsz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function probablyInString(state, pos, quoteToken) {
    let node = _language.syntaxTree(state).resolveInner(pos, -1);
    for(let i = 0; i < 5; i++){
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@codemirror/rangeset":"2SfPZ","@codemirror/text":"1TE0D","@codemirror/language":"gATQT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4laib":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@codemirror/panel":"5l4Kc","@codemirror/rangeset":"2SfPZ","crelt":"kpxRX","@codemirror/text":"1TE0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5l4Kc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kpxRX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function crelt() {
    var elt = arguments[0];
...
},{"@codemirror/state":"80zPS","@codemirror/view":"fBkgq","@codemirror/tooltip":"iwWKb","@codemirror/language":"gATQT","@codemirror/text":"1TE0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iwWKb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
*/ function hoverTooltip(source, options = {
    ...
    return [
        hoverState,
        _view.ViewPlugin.define((view)=>new HoverPlugin(view, source, hoverState, setHover, options.hoverTime || 300 /* Time */ )
        ),
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iuCDm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
block comments.
*/ const toggleBlockCommentByLine = /*@__PURE__*/ command((o, s)=>changeBlockComment(o, s, selectedLineRanges(s))
, 0 /* Toggle */ );
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h0fKo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/state":"80zPS","@codemirror/view":"fBkgq","@codemirror/text":"1TE0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"27yTu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@lezer/common":"6NJEQ","style-mod":"hU20f","@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@codemirror/language":"gATQT","@codemirror/rangeset":"2SfPZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5PM0d":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@codemirror/view":"fBkgq","@codemirror/state":"80zPS","@codemirror/tooltip":"iwWKb","@codemirror/panel":"5l4Kc","@codemirror/gutter":"9zb6V","@codemirror/rangeset":"2SfPZ","crelt":"kpxRX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}]},["eYk8U","ixaFm"], "ixaFm", "parcelRequire5892")
